...
if {$make_assignments} {
	...
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_txtransactor_if_simple.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_tx_mux.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_rxtransactor_if_simple.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_clock_crossing_if.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_status_buffer.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_rxram_shim.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_rxram_mux.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_packet_parser.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_dualportram_tx.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_dualportram_rx.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_dualportram.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_do_rx_reset.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_byte_sum.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_build_status.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_build_resend.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_build_ping.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_buffer_selector.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_rarp_block.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_build_payload.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_build_arp.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_ipaddr_block.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/transactor_cfg.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/transactor_sm.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/transactor_if.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/transactor.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/trans_arb.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_transport_udp/firmware/hdl/udp_if_flat.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_slaves/firmware/hdl/ipbus_peephole_ram.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_slaves/firmware/hdl/ipbus_ram.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_slaves/firmware/hdl/ipbus_reg_v.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_slaves/firmware/hdl/ipbus_ctrlreg_v.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/ipbus_fabric_sel.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_util/firmware/hdl/ipbus_clock_div.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/ipbus_trans_decl.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_util/firmware/hdl/ipbus_decode_ipbus_example.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_core/firmware/hdl/ipbus_package.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_slaves/firmware/hdl/ipbus_reg_types.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_util/firmware/hdl/ipbus_example.vhd
	set_global_assignment -name VHDL_FILE ../IPbus_code/components/ipbus_util/firmware/hdl/masters/ipbus_ctrl.vhd
